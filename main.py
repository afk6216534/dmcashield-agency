    ...
    return jsonify(
        {
            ...
            "departments": {
                "scraping": {
                    "head": {"name": "ScrapeHead", "status": "online"},
                    "team_size": 2,
                },
                "validation": {
                    "head": {"name": "EnrichHead", "status": "online"},
                    "team_size": 2,
                },
                "marketing": {
                    "head": {"name": "MarketingHead", "status": "online"},
                    "team_size": 2,
                },
                "sending": {
                    "head": {"name": "SendHead", "status": "online"},
                    "team_size": 2,
                },
                "analytics": {
                    "head": {"name": "AnalyticsHead", "status": "online"},
                    "team_size": 2,
                },
                "sales": {
                    "head": {"name": "SalesHead", "status": "online"},
                    "team_size": 2,
                },
                "sheets": {
                    "head": {"name": "SheetsHead", "status": "online"},
                    "team_size": 1,
                },
                "accounts": {
                    "head": {"name": "AccountsHead", "status": "online"},
                    "team_size": 2,
                },
                "tasks": {
                    "head": {"name": "TaskHead", "status": "online"},
                    "team_size": 2,
                },
                "ml": {"head": {"name": "MLHead", "status": "online"}, "team_size": 2},
                "jarvis": {
                    "head": {"name": "JARVISHead", "status": "online"},
                    "team_size": 2,
                },
                "memory": {
                    "head": {"name": "MemoryHead", "status": "online"},
                    "team_size": 2,
                },
            },
            "department_count": 12,
...
DEMO_LEADS = [
    {
        ...
        "email_primary": "sarah@smileclinic.com",
        "phone": "555-0101",
        "city": "Los Angeles",
        "state": "CA",
        "niche": "dentist",
        "current_rating": 3.8,
        "negative_review_count": 7,
        "lead_score": 85,
        ...
        "full_address": "123 Smile Ave, Los Angeles, CA 90001",
        ...
        "important_notes": "Referred by Dr. Johnson - high priority",
        "last_contact": "2026-05-04T10:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-01",
                "type": "email_sent",
            ...
            },
            {
                "date": "2026-05-03",
                "type": "email_sent",
                "subject": "review reputation",
                "result": "replied",
            },
        ],
        "competitors": ["West LA Dental", "Smile Studio LA"],
        "services_offered": ["General Checkups", "Whitening", "Crowns", "Implants"],
        "review_platforms": {"google": 3.8, "yelp": 4.0, "healthgrades": 4.5},
        "pain_points": ["wait times", "billing confusion"],
        "call_script_notes": "Mention her UCLA background, ask about cosmetic dentistry interest",
        "closing_probability": 85,
    },
    {
        "id": "l2",
        "business_name": "Houston Auto Repair",
        "owner_name": "Mike Johnson",
        "email_primary": "mike@houstonauto.com",
        "phone": "555-0102",
        "city": "Houston",
        "state": "TX",
        "niche": "auto repair",
        ...
        "website": "https://houstonautorepair.com",
        "full_address": "456 Motor Lane, Houston, TX 77001",
        ...
        "important_notes": "",
        "last_contact": "2026-05-03T14:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-02",
                "type": "email_sent",
                "subject": "online reviews matter",
                "result": "opened",
            }
        ],
        "competitors": ["QuickFix Auto", "ProTech Motors", "Texas Auto Care"],
        "services_offered": ["Oil Change", "Brakes", "Tires", "Engine Repair"],
        "review_platforms": {"google": 4.2, "yelp": 3.9, "bbb": 4.5},
        "pain_points": ["turnaround time", "pricing transparency"],
        "call_script_notes": "Ask about fleet services, mention local business discount",
        "closing_probability": 72,
    },
    {
        "id": "l3",
        "business_name": "Legal Eagles LLP",
        "owner_name": "James White",
        "email_primary": "james@legaleagles.com",
        "phone": "555-0103",
        "city": "Chicago",
        "state": "IL",
        "niche": "law firm",
        ...
        "website": "https://legaleaglesllp.com",
        "full_address": "789 Legal Plaza, Chicago, IL 60601",
        ...
        "gmail_important": True,
        "important_notes": "High value client - already interested in DMCA services",
        "last_contact": "2026-05-05T09:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-01",
                "type": "email_sent",
            ...
            },
            {
                "date": "2026-05-03",
                "type": "reply_received",
                "content": "Interested in learning more about your services",
            },
        ],
        "competitors": ["Smith & Associates", "Chicago Legal Group"],
        "services_offered": [
            "Personal Injury",
            "Corporate Law",
            "IP Protection",
        ...
        "review_platforms": {"google": 4.8, "yelp": 4.6, "avvo": 5.0},
        "pain_points": ["client acquisition"],
        "call_script_notes": "Offer free consultation, mention case study protection, ask about trademark needs",
    ...
    },
    {
        ...
        "email_primary": "tom@pizzapalace.com",
        "phone": "555-0104",
        "city": "Denver",
        "state": "CO",
        "niche": "restaurant",
        ...
        "website": "https://pizzapalacedenver.com",
        "full_address": "321 Food Court, Denver, CO 80201",
        "business_nature": "Italian Restaurant & Pizza Delivery",
        "years_in_business": 3,
        "employee_count": "5-8",
        "revenue_range": "$200K-$400K",
        ...
        "gmail_important": False,
        "important_notes": "",
        "last_contact": "2026-05-03T16:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-03",
                "type": "email_sent",
                "subject": "denver restaurants",
                "result": "delivered",
            }
        ],
        "competitors": ["Domino's", "Papa John's", "Local Pizza Co"],
        "services_offered": ["Dine-in", "Delivery", "Catering"],
        "review_platforms": {"google": 3.5, "yelp": 3.2, "tripadvisor": 3.0},
        "pain_points": ["food quality", "service speed", "inconsistent orders"],
        "call_script_notes": "Empathize with startup challenges, offer affordable starter package",
        "closing_probability": 45,
    },
    {
        "id": "l5",
        "business_name": "Bright Eyes Optometry",
        "owner_name": "Dr. Lisa Chen",
        "email_primary": "lisa@brighteyes.com",
        "phone": "555-0105",
        "city": "Phoenix",
        "state": "AZ",
        "niche": "optometrist",
        ...
        "website": "https://brighteyesoptometry.com",
        "full_address": "555 Vision Way, Phoenix, AZ 85001",
        "business_nature": "Optometry & Vision Care Services",
        "years_in_business": 10,
        "employee_count": "8-12",
        "revenue_range": "$800K-$1.2M",
        ...
        "gmail_important": True,
        "important_notes": "Referred by medical association - follow up this week",
        "last_contact": "2026-05-04T11:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-02",
                "type": "email_sent",
                "subject": "phoenix optometry",
                "result": "opened",
            },
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "vision care reviews",
                "result": "opened",
            },
        ],
        "competitors": [
        ...
        "review_platforms": {"google": 4.5, "yelp": 4.3, "healthgrades": 4.7},
        "pain_points": ["appointment scheduling", "insurance processing"],
        "call_script_notes": "Mention pediatric specialty, ask about school screening programs",
        "closing_probability": 78,
    },
    {
        "id": "l6",
        "business_name": "Paws & Claws Veterinary",
        "owner_name": "Dr. Marcus Rivera",
        "email_primary": "marcus@pawsandclaws.com",
        "phone": "555-0106",
        "city": "Miami",
        "state": "FL",
        "niche": "veterinarian",
        ...
        "website": "https://pawsandclaws.vet",
        "full_address": "890 Pet Blvd, Miami, FL 33101",
        "business_nature": "Full-Service Veterinary Clinic & Emergency Care",
        "years_in_business": 12,
        "employee_count": "15-20",
        "revenue_range": "$1.5M-$2.5M",
        ...
        "gmail_important": False,
        "important_notes": "",
        "last_contact": "2026-05-04T15:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-03",
                "type": "email_sent",
                "subject": "miami vet reviews",
                "result": "opened",
            }
        ],
        "competitors": [
        ...
        "review_platforms": {"google": 4.1, "yelp": 3.8, "zocdoc": 4.3},
        "pain_points": ["pricing concerns", "wait times"],
        "call_script_notes": "Mention emergency services capability, ask about expansion plans",
    ...
    },
    {
        ...
        "email_primary": "jennifer@techstartsolutions.com",
        "phone": "555-0107",
        "city": "Seattle",
        "state": "WA",
        "niche": "IT services",
        ...
        "full_address": "456 Tech Lane, Seattle, WA 98101",
        "business_nature": "IT Consulting & Managed Services for SMBs",
        "years_in_business": 7,
        "employee_count": "12-18",
        "revenue_range": "$1.2M-$2M",
        ...
        "gmail_important": True,
        "important_notes": "Met at tech conference - interested in reputation management for her company",
        "last_contact": "2026-05-05T10:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-01",
                "type": "email_sent",
                "subject": "seattle it company reviews",
                "result": "opened",
            },
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "business reputation",
                "result": "opened",
            },
        ],
        "competitors": ["Seattle IT Pros", "TechConnect", "NW Managed Services"],
        "services_offered": [
            "IT Consulting",
            "Managed Services",
            "Cloud Setup",
        ...
        "review_platforms": {"google": 4.6, "clutch": 4.8, "yelp": 4.2},
        "pain_points": ["response time", "scalability"],
        "call_script_notes": "Mention cybersecurity growth, ask about client testimonial needs",
    ...
    },
    {
        ...
        "email_primary": "carlos@greenthumbland.com",
        "phone": "555-0108",
        "city": "Austin",
        "state": "TX",
        "niche": "landscaping",
        ...
        "full_address": "789 Garden Way, Austin, TX 78701",
        "business_nature": "Residential & Commercial Landscaping Services",
        "years_in_business": 5,
        "employee_count": "8-12",
        "revenue_range": "$400K-$700K",
        ...
        "gmail_important": False,
        "important_notes": "",
        "last_contact": "2026-05-05T08:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "austin landscaping",
                "result": "delivered",
            }
        ],
        "competitors": [
        ...
        "review_platforms": {"google": 3.9, "yelp": 3.5, "nextdoor": 4.0},
        "pain_points": ["missed appointments", "communication", "scheduling"],
        "call_script_notes": "Offer scheduling system help, mention commercial opportunities",
        "closing_probability": 55,
    },
    {
        "id": "l9",
        "business_name": "Sunrise Fitness Center",
        "owner_name": "Rachel Torres",
        "email_primary": "rachel@sunrisefitness.com",
        "phone": "555-0109",
        "city": "San Diego",
        "state": "CA",
        "niche": "gym/fitness",
        ...
        "status": "funnel_ready",
        "funnel_step": 4,
        "emails_sent_count": 11,
        "created_at": "2026-05-02T07:00:00Z",
        "website": "https://sunrisefitnessgym.com",
        "full_address": "321 Fitness Ave, San Diego, CA 92101",
        "business_nature": "24/7 Fitness Center & Personal Training",
        "years_in_business": 9,
        "employee_count": "20-25",
        "revenue_range": "$1M-$1.8M",
        ...
        "gmail_important": True,
        "important_notes": "Expanding to second location - needs help with new location reviews",
        "last_contact": "2026-05-05T14:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-02",
                "type": "email_sent",
                "subject": "san diego gym reviews",
                "result": "opened",
            },
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "fitness reputation",
                "result": "replied",
            },
        ],
        "competitors": [
        ...
        "review_platforms": {"google": 4.3, "yelp": 4.1, "facebook": 4.5},
        "pain_points": ["crowding", "equipment maintenance"],
        "call_script_notes": "Ask about second location plans, offer to help with new location reviews",
        "closing_probability": 75,
    },
    {
        "id": "l10",
        "business_name": "Elite Hair Studio",
        "owner_name": "Patricia Kim",
        "email_primary": "patricia@elitehairstudio.com",
        "phone": "555-0110",
        "city": "New York",
        "state": "NY",
        "niche": "salon",
        ...
        "status": "replied",
        "funnel_step": 5,
        "emails_sent_count": 14,
        "created_at": "2026-05-01T12:00:00Z",
        "website": "https://elitehairstylonyc.com",
        "full_address": "555 Fifth Avenue, New York, NY 10018",
        ...
        "gmail_important": True,
        "important_notes": "High-value - concerned about unauthorized use of her styles online",
        "last_contact": "2026-05-06T09:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-01",
                "type": "email_sent",
                "subject": "nyc salon reviews",
                "result": "opened",
            },
            {
                "date": "2026-05-03",
            ...
            },
            {
                "date": "2026-05-05",
                "type": "reply_received",
                "content": "Can you help protect my work from being stolen?",
            },
        ],
        "competitors": ["Sally Hershberger", "Umberto Giannini", "John Frieda"],
        "services_offered": [
            "Cut & Style",
            "Color",
            "Extensions",
        ...
        "review_platforms": {"google": 4.7, "yelp": 4.8, "vogue": 5.0},
        "pain_points": ["image theft", "competitor copying"],
        "call_script_notes": "Focus on DMCA for image protection, mention competitor research",
        "closing_probability": 82,
    },
    {
        "id": "l11",
        "business_name": "Blue Ocean Plumbing",
        "owner_name": "David Chen",
        "email_primary": "david@blueoceanplumbing.com",
        "phone": "555-0111",
        "city": "Boston",
        "state": "MA",
        "niche": "plumbing",
        ...
        "emails_sent_count": 6,
        "created_at": "2026-05-04T10:00:00Z",
        "website": "https://blueoceanplumbing.com",
        "full_address": "678 Pipe Street, Boston, MA 02101",
        ...
        "gmail_important": False,
        "important_notes": "",
        "last_contact": "2026-05-05T11:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "boston plumbing reviews",
                "result": "opened",
            }
        ],
        "competitors": ["Roto-Rooter", "Boston Plumbers", "Mario & Son"],
        "services_offered": [
            "Repairs",
            "Installation",
            "Drain Cleaning",
        ...
        "review_platforms": {"google": 4.0, "yelp": 3.7, "bbb": 4.2},
        "pain_points": ["pricing transparency", "scheduling"],
        "call_script_notes": "Offer pricing transparency help, mention emergency serviceupsell",
        "closing_probability": 62,
    },
    {
        "id": "l12",
        "business_name": "Sunshine Daycare Center",
        "owner_name": "Maria Santos",
        "email_primary": "maria@sunshinedaycare.com",
        "phone": "555-0112",
        "city": "Atlanta",
        "state": "GA",
        "niche": "daycare",
        ...
        "website": "https://sunshinedaycarecenter.com",
        "full_address": "234 Child Way, Atlanta, GA 30301",
        "business_nature": "Childcare & Early Education Center",
        "years_in_business": 8,
        "employee_count": "15-20",
        "revenue_range": "$600K-$900K",
        ...
        "gmail_important": False,
        "important_notes": "",
        "last_contact": "2026-05-05T16:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-03",
                "type": "email_sent",
                "subject": "atlanta daycare",
                "result": "opened",
            },
            {
                "date": "2026-05-05",
                "type": "email_sent",
                "subject": "childcare reviews",
                "result": "opened",
            },
        ],
        "competitors": ["KinderCare", "Learning Care Group", "The Little School"],
        "services_offered": [
            "Infant Care",
            "Toddler Care",
            "Preschool",
        ...
        "review_platforms": {"google": 4.4, "yelp": 4.2, "care.com": 4.6},
        "pain_points": ["waitlist", "enrollment process"],
        "call_script_notes": "Mention before/after school programs, ask about expansion plans",
        "closing_probability": 70,
    },
    {
        "id": "l13",
        "business_name": "Urban Eats Restaurant",
        "owner_name": "James Park",
        "email_primary": "james@urbaneats.com",
        "phone": "555-0113",
        "city": "Portland",
        "state": "OR",
        "niche": "restaurant",
        ...
        "website": "https://urbaneatspdx.com",
        "full_address": "567 Foodie Lane, Portland, OR 97201",
        "business_nature": "Modern American Fusion Restaurant",
        "years_in_business": 2,
        "employee_count": "12-15",
        "revenue_range": "$500K-$800K",
        ...
        "gmail_important": False,
        "important_notes": "Struggling - needs affordable help",
        "last_contact": "2026-05-05T14:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-05",
                "type": "email_sent",
                "subject": "portland restaurants",
                "result": "delivered",
            }
        ],
        "competitors": ["Pok Pok", "Le Pigeon", "Central Cafe"],
        "services_offered": ["Dinner Service", "Private Dining", "Catering", "Takeout"],
        "review_platforms": {"google": 3.6, "yelp": 3.4, "tripadvisor": 3.5},
        "pain_points": ["inconsistency", "slow service", "new restaurant challenges"],
        "call_script_notes": "Empathize with startup struggles, offer affordable starter package",
        "closing_probability": 48,
    },
    {
        "id": "l14",
        "business_name": "Prestige Auto Detailing",
        "owner_name": "Tony Martinez",
        "email_primary": "tony@prestigeautodetailing.com",
        "phone": "555-0114",
        "city": "Las Vegas",
        "state": "NV",
        ...
        "website": "https://prestigeautodetailinglv.com",
        "full_address": "890 Shine Way, Las Vegas, NV 89101",
        ...
        "gmail_important": True,
        "important_notes": "High-quality - expanding mobile service",
        "last_contact": "2026-05-05T13:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-02",
                "type": "email_sent",
                "subject": "las vegas auto detailing",
                "result": "opened",
            },
            {
                "date": "2026-05-04",
                "type": "email_sent",
                "subject": "luxury car reviews",
                "result": "replied",
            },
        ],
        "competitors": [
        ...
        "review_platforms": {"google": 4.8, "yelp": 4.9, "facebook": 5.0},
        "pain_points": ["appointment scheduling"],
        "call_script_notes": "Ask about mobile expansion, mention casino fleet opportunities",
        "closing_probability": 90,
    },
    {
        "id": "l15",
        "business_name": "Mindful Psychology Group",
        "owner_name": "Dr. Amanda Foster",
        "email_primary": "amanda@mindfulpsychgroup.com",
        "phone": "555-0115",
        "city": "Denver",
        "state": "CO",
        "niche": "psychology/therapy",
        "current_rating": 4.9,
        ...
        "status": "replied",
        "funnel_step": 5,
        "emails_sent_count": 16,
        "created_at": "2026-05-01T09:00:00Z",
        "website": "https://mindfulpsychologygroup.com",
        "full_address": "123 Wellness Center, Denver, CO 80202",
        ...
        "gmail_important": True,
        "important_notes": "Elite client - wants to protect her podcast content from theft",
        "last_contact": "2026-05-06T11:00:00Z",
        "interaction_history": [
            {
                "date": "2026-05-01",
                "type": "email_sent",
                "subject": "denver therapy reviews",
                "result": "opened",
            },
            {
                "date": "2026-05-03",
            ...
            },
            {
                "date": "2026-05-05",
                "type": "reply_received",
                "content": "Need help protecting my podcast episodes",
            },
        ],
        "competitors": [
            "Denver Therapy Associates",
        ...
        "review_platforms": {"google": 4.9, "psychologytoday": 5.0, "yelp": 4.8},
        "pain_points": ["content theft", "brand protection"],
        "call_script_notes": "Focus on content DMCA protection, mention podcast growth opportunities",
        ...
        [
            {
                ...
                "emails_sent_count": l["emails_sent_count"],
            }
            for l in scored
        ]
    )
...
DEMO_ACCOUNTS = [
    {
        "id": "a1",
        "email_address": "campaign@dmcashield.com",
    ...
    {
        "id": "a2",
        "email_address": "outreach@dmcashield.com",
        "display_name": "DMCA Support",
        "daily_limit": 30,
        "sent_today": 15,
        "total_sent": 234,
        "warmup_day": 14,
...
def add_account():
    ...
    try:
        ...
        return jsonify(
            {"id": new_id, "email_address": email_address, "status": "warming_up"}
        )
...
def start_warmup(account_id):
    try:
        ...
        conn = get_db()
        conn.execute(
            "UPDATE email_accounts SET status = 'warming_up' WHERE id = ?",
            (account_id,),
        )
        conn.commit()
        conn.close()
...
def stop_warmup(account_id):
    try:
        ...
        conn = get_db()
        conn.execute(
            "UPDATE email_accounts SET status = 'paused' WHERE id = ?", (account_id,)
        )
        conn.commit()
        conn.close()
        try:
...
DEMO_TEMPLATES = [
    {
        "id": "ft1",
        "name": "DMCA Cold Outreach (6 Steps)",
        "steps": [
            {
                "step": 1,
                "delay_days": 0,
            ...
            },
            {
                ...
                "delay_days": 3,
                "angle": "social_proof",
                "emotion_trigger": "trust",
            },
            {
                "step": 3,
                "delay_days": 7,
                "angle": "fear_trigger",
                "emotion_trigger": "urgency",
            },
            {
                "step": 4,
                "delay_days": 14,
            ...
            },
            {
                ...
                "delay_days": 21,
                "angle": "last_chance",
                "emotion_trigger": "fomo",
            },
            {
                "step": 6,
                "delay_days": 28,
                "angle": "breakup",
                "emotion_trigger": "loss",
            },
        ],
...
def jarvis():
    ...
    if "how many" in message and "lead" in message:
        return jsonify(
            {
                "response": "You have 247 total leads: 38 hot, 45 warm, 164 cold.",
                "type": "info",
            }
        )
        ...
        return jsonify(
            {
                "response": "System: operational. 12 departments active, 36 agents running. All systems nominal.",
                "type": "info",
            }
        )
        ...
        return jsonify(
            {
                "response": "Email stats: 1247 sent, 349 opened (28% open rate), 89 replies (7.1% reply rate).",
                "type": "info",
            }
        )
        ...
        return jsonify(
            {
                "response": "You have 2 email accounts registered. 1 active, 1 warming up.",
                "type": "info",
            }
        )
        ...
        return jsonify(
            {
                "response": "Learning engine at cycle 4. Current open rate: 28%. Best subject style: short personalized. 1 discovered rule.",
                "type": "info",
            }
        )
    ...
    return jsonify(
        {
            ...
            "Try: 'how many leads', 'show stats', 'system status', or 'learning cycle'.",
            "type": "info",
        }
    )
    ...
    return jsonify(
        {
            ...
            "email_gap_max": 420,
            "models": {
                "copywriting": "google/gemini-2.0-flash-exp:free",
...
def test_integration(integration_type):
    ...
    result = statuses.get(
        integration_type,
        {"status": "not_supported", "message": f"'{integration_type}' not implemented"},
    )
    ...
    return jsonify(
        {
            ...
            "rules": [
                "Use 2-4 word lowercase subjects",
...
DEMO_DMCA_CASES = [
    {
        "id": "dmca1",
        "client_name": "Smile Dental Clinic",
        "platform": "Google",
        "status": "submitted",
        "negative_reviews_removed": 3,
        "submitted_at": "2026-05-01T10:00:00Z",
    },
    {
        "id": "dmca2",
        "client_name": "Houston Auto Repair",
        "platform": "Yelp",
        "status": "under_review",
        "negative_reviews_removed": 0,
        "submitted_at": "2026-05-03T14:00:00Z",
    },
    {
        "id": "dmca3",
        "client_name": "Legal Eagles LLP",
        "platform": "Google",
        "status": "completed",
        "negative_reviews_removed": 5,
...
DEMO_SCHEDULES = [
    {
        "id": "sch1",
        "campaign_id": "t1",
        "scheduled_at": "2026-05-05T14:00:00Z",
        "action": "send_batch",
        "status": "pending",
        "leads_count": 20,
    },
...
def create_schedule():
    ...
    sch = {
        ...
        "action": data.get("action", "send_batch"),
        "status": "pending",
...
AI_BRAINS = {
    ...
    "ceo": {
        ...
        "mood": "excited",
        "confidence": 0.9,
        "skills": {"strategy": 0.85, "decision_making": 0.9, "leadership": 0.8},
        "decisions_made": 89,
    ...
    return jsonify(
        {
            "status": "learned",
            "skill": skill,
            "new_level": AI_BRAINS[department]["skills"].get(skill, 0),
        }
    )
...
DEPT_INFO = {
    "scraping": {
        "title": "Scraping Department",
        "icon": "🕵️",
        "description": "Finds and scrapes business leads from Google Maps",
        "pipeline": [
            "Target Search",
            "Google Maps Scan",
            "Data Extraction",
    ...
    "validation": {
        ...
        "icon": "✅",
        "description": "Verifies and enriches raw leads with owner names, emails, and scores",
        "pipeline": [
            "Email Verification",
            "Owner Name Lookup",
            "Phone Enrichment",
    ...
    "marketing": {
        ...
        "icon": "📣",
        "description": "AI-powered email copywriting with funnel sequences",
        "pipeline": [
            "Audience Analysis",
        ...
        "techniques": [
            "PAS framework",
            "2-4 word lowercase subjects",
            "Personalization tokens",
            "Fear triggers",
            "Social proof",
            "5-email funnel sequence",
    ...
    "sending": {
        "title": "Email Sending",
        "icon": "📧",
        "description": "Multi-account SMTP sending with throttling and deliverability protection",
        "pipeline": [
            "Account Selection",
            "Warmup Check",
            "Rate Limiting",
        ...
        "kpis": {
            "sent_today": 142,
            "bounce_rate": "2.1%",
            "daily_limit": "500/account",
        },
    },
    "analytics": {
        "title": "Analytics & Tracking",
        "icon": "📊",
        "description": "Tracks email opens, clicks, replies, and calculates performance",
        "pipeline": [
            "Open Tracking",
            "Click Tracking",
            "Reply Detection",
    ...
    "sales": {
        ...
        "icon": "💰",
        "description": "Detects interested replies, classifies intent, and manages the sales pipeline",
        "pipeline": [
            "Reply Detection",
    ...
    "accounts": {
        ...
        "icon": "👤",
        "description": "Manages email accounts, warmup, health monitoring, and rotation",
        "pipeline": [
            "Account Setup",
            "SMTP/IMAP Verify",
            "Warmup Phase",
        ...
        "techniques": [
            ...
            "SPF/DKIM checks",
            "Reputation scoring",
            "Auto-rotation on bounce",
            "Deliverability testing",
        ],
        "kpis": {
            "active_accounts": 3,
            "warmup_progress": "Phase 3",
            "health_score": "92%",
        },
    },
    "tasks": {
        ...
        "icon": "📌",
        "description": "Orchestrates scraping tasks, queues work, and tracks progress",
        "pipeline": [
            "Task Creation",
            "CEO Approval",
            "Scraping Dispatch",
        ...
        "kpis": {
            ...
            "completed_tasks": 45,
            "avg_completion_time": "4.5 hrs",
        },
    },
    "ml": {
        "title": "Machine Learning",
        "icon": "🤖",
        "description": "Self-learning engine that optimizes strategies based on performance data",
        "pipeline": [
            "Data Collection",
            "Pattern Analysis",
            "Rule Discovery",
    ...
    "jarvis": {
        ...
        "icon": "🧠",
        "description": "AI-powered assistant that answers questions and executes commands",
        "pipeline": [
            "Command Parsing",
            "Intent Detection",
            "Data Retrieval",
    ...
    "memory": {
        "title": "Memory & Soul",
        "icon": "💾",
        "description": "Persistent memory system — stores agent decisions, learnings, and system soul",
        "pipeline": [
            "Decision Logging",
            "Outcome Tracking",
            "Pattern Storage",
        ...
        "techniques": [
            "JSON persistence",
            "Brain memory (per-agent)",
            "Soul file (company state)",
            "Decision replay",
        ],
        "kpis": {
            "memories_stored": 847,
    ...
    "sheets": {
        "title": "Sheets & Data Sync",
        "icon": "📋",
        "description": "Syncs lead data, exports, and manages CSV/database operations",
        "pipeline": [
            "Data Export",
            "CSV Generation",
            "Database Sync",
        ...
        "kpis": {
            "records_synced": len(DEMO_LEADS),
            "last_backup": "2 hrs ago",
            "export_count": 12,
        },
    },
}
...
MESSAGE_LOG = [
    {
        ...
        "message_type": "handoff",
        "priority": "high",
        "notes": "25 new leads scraped from Los Angeles clinics",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "EnrichHead",
        ...
        "message_type": "handoff",
        "priority": "normal",
        "notes": "18 leads verified and enriched, ready for funnel",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "MarketingHead",
        ...
        "message_type": "handoff",
        "priority": "normal",
        "notes": "Funnel emails generated for 18 leads (PAS framework)",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "SendHead",
        ...
        "message_type": "alert",
        "priority": "normal",
        "notes": "38 emails opened today, 12 replies detected",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "AnalyticsHead",
        ...
        "message_type": "handoff",
        "priority": "high",
        "notes": "5 hot leads identified with buying intent",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "MLHead",
        ...
        "message_type": "report",
        "priority": "normal",
        "notes": "Learning cycle 7 complete — 2-4 word subjects outperforming",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "CEO",
        ...
        "priority": "high",
        "notes": "New task: Scrape dentists in Houston, TX",
        "timestamp": datetime.utcnow().isoformat(),
    },
    {
        "from": "SalesHead",
        ...
        "message_type": "report",
        "priority": "high",
        "notes": "Dr. Amanda Foster interested in DMCA services — schedule call",
        "timestamp": datetime.utcnow().isoformat(),
    },
]
...
def chat_with_department(dept_name):
    ...
    if any(
        ...
        if any(
            w in msg_lower for w in ["funnel", "step", "sequence", "email", "series"]
        ):
            ...
            funnel_templates = [
                {
                    "name": "Cold Intro",
                    "goal": "Break the ice, get attention",
                    "timing": "Day 0",
                },
                {
                    "name": "Social Proof",
                ...
                {
                    "name": "Pain Point",
                    "goal": "Identify their specific problem",
                    "timing": "Day 4",
                },
                {
                    "name": "Fear Trigger",
                    "goal": "Show cost of inaction",
                    "timing": "Day 6",
                },
                {
                    "name": "Education",
                    "goal": "Teach them about reputation impact",
                    "timing": "Day 8",
                },
                {
                    "name": "Competitor Alert",
                    "goal": "Show competitors are ahead",
                    "timing": "Day 10",
                },
                {
                    "name": "Value Offer",
                    "goal": "Present your solution clearly",
                    "timing": "Day 13",
                },
                {
                    "name": "Case Study Deep-Dive",
                    "goal": "Detailed success story",
                    "timing": "Day 16",
                },
                {
                    "name": "Urgency Push",
                    "goal": "Limited time / spots available",
                    "timing": "Day 19",
                },
                {
                    "name": "Direct Ask",
                    "goal": "Clear CTA with easy next step",
                    "timing": "Day 22",
                },
                {
                    "name": "Testimonial Blast",
                    "goal": "Multiple client wins",
                    "timing": "Day 25",
                },
                {
                    "name": "Last Chance",
                    "goal": "Final opportunity before closing",
                    "timing": "Day 28",
                },
                {
                    "name": "Breakup Email",
                    "goal": "Closing their file — reverse psychology",
                    "timing": "Day 30",
                },
                {
                    "name": "Re-Engagement",
                    "goal": "Come back with new offer",
                    "timing": "Day 45",
                },
                {
                    "name": "Holiday Special",
                    "goal": "Seasonal re-engagement",
                    "timing": "Day 60",
                },
            ]
            ...
            MESSAGE_LOG.append(
                {
                    ...
                    "message_type": "instruction",
                    "priority": "high",
                    "notes": f"CEO requested {steps}-step funnel sequence",
                    "timestamp": datetime.utcnow().isoformat(),
                }
            )
            MESSAGE_LOG.append(
                {
                    ...
                    "message_type": "report",
                    "priority": "normal",
                    "notes": f"Generated {steps}-step funnel — notifying Copywriter and SendHead",
                    "timestamp": datetime.utcnow().isoformat(),
                }
            )
            ...
            response += (
                f"📊 **AnalyticsHead** will track open/click/reply for each step.\n"
            )
    ...
    if "status" in msg_lower or msg_lower.strip() == "how are you":
        ...
        response += (
            f"🧠 Brain memory: {agents['head'].get('brain_size', 0)} entries\n\n"
        )
        ...
        w in msg_lower for w in ["report", "numbers", "stats", "data", "metric", "kpi"]
    ):
        kpis = info.get("kpis", {})
        ...
        w in msg_lower for w in ["change", "switch", "update", "modify", "adjust"]
    ):
        # Log the instruction
        MESSAGE_LOG.append(
            {
        ...
        MESSAGE_LOG.append(
            {
                ...
                "message_type": "instruction",
                "priority": "high",
                "notes": f"PAUSED by CEO: {msg}",
                "timestamp": datetime.utcnow().isoformat(),
            }
        )
        response = (
            f"**{agent_name}**: ⏸️ Understood! Department operations **paused**.\n"
        )
...
def send_department_command(dept_name):
    ...
    MESSAGE_LOG.append(
        {
            "from": "CEO",
            "to": DEPT_AGENTS.get(dept_name, {}).get("head", {}).get("name", dept_name),
            "message_type": "instruction",
            "priority": "high",
            "notes": f"CEO command: {command}",
            "timestamp": datetime.utcnow().isoformat(),
        }
    )
    return jsonify(
...
def get_campaigns():
    campaigns = [
        {
            "id": 1,
            "name": "DMCA Removal Outreach — Dentists LA",
            "status": "active",
            "sent": 1247,
            "opened": 349,
            "replied": 112,
        ...
        {
            "id": 2,
            "name": "Review Response — Lawyers NYC",
            "status": "active",
            "sent": 892,
            "opened": 234,
            "replied": 67,
        ...
        {
            "id": 3,
            "name": "Reputation Shield — Med Spas Miami",
            "status": "running",
            "sent": 456,
            "opened": 123,
            "replied": 34,
        ...
        {
            "id": 4,
            "name": "DMCA Awareness — Chiropractors Houston",
            "status": "scheduled",
            "sent": 0,
            "opened": 0,
            "replied": 0,
...
def jarvis_chat():
    ...
    if department and department in DEPT_INFO:
        ...
        response = (
            "📣 **Marketing Funnel (5-Email Sequence):**\n\n"
            + "\n".join(
                [
                    f"**Step {f['step']}: {f['name']}** — {f['goal']} ({f['timing']})"
                    for f in funnel
                ]
            )
        ...
        top_agents = sorted(
            AGENT_BRAINS.items(),
            key=lambda x: (
                max(x[1].get("skills", {}).values()) if x[1].get("skills") else 0
            ),
            reverse=True,
        )[:5]
        ...
        top_agents = sorted(
            AGENT_BRAINS.items(),
            key=lambda x: (
                sum(x[1].get("skills", {}).values())
                / max(len(x[1].get("skills", {})), 1)
            ),
            reverse=True,
        )[:10]
        ...
        response = "🏢 **Your Departments:**\n\n" + "\n".join(
            f"{info['icon']} **{info['title']}** — online ({DEPT_AGENTS.get(name, {}).get('head', {}).get('name', 'N/A')})"
            for name, info in DEPT_INFO.items()
        )
    elif "help" in msg:
        ...
        w in msg for w in ["cold email", "email tip", "email best", "outreach tip"]
    ):
        principles = KNOWLEDGE_BASE["cold_email_knowledge"]["principles"]
        frameworks = KNOWLEDGE_BASE["cold_email_knowledge"]["frameworks"][:3]
        response = (
            "📧 **Cold Email Mastery** (from marketingskills repo):\n\n**Core Principles:**\n"
            + "\n".join(f"✅ {p}" for p in principles[:5])
        )
        response += "\n\n**Top Frameworks:**\n" + "\n".join(
            f"🔧 **{f['name']}**: {f['desc']}" for f in frameworks
        )
        response += "\n\n**Anti-Patterns (NEVER do):**\n" + "\n".join(
            f"❌ {a}"
            for a in KNOWLEDGE_BASE["cold_email_knowledge"]["anti_patterns"][:3]
        )
        ...
        response += "\n\n**Pricing Psychology:**\n" + "\n".join(
            f"💰 {p}"
            for p in KNOWLEDGE_BASE["psychology_knowledge"]["pricing_psychology"][:3]
        )
        ...
        response += "\n".join(
            f"📄 **{m['type']}**: {m['name']} — Est. conversion: {m['conversion']}"
            for m in magnets
        )
        response += "\n\n**Key Principles:**\n" + "\n".join(
            f"✅ {p}" for p in KNOWLEDGE_BASE["lead_magnet_knowledge"]["principles"]
        )
        ...
        response += "**Active Experiments:**\n" + "\n".join(
            f"{'🔄' if e['status'] == 'running' else '✅'} **{e['name']}**: {e['hypothesis']}"
            for e in exps
        )
        response += "\n\n**Rules:**\n" + "\n".join(
            f"📏 {r}" for r in KNOWLEDGE_BASE["ab_testing_knowledge"]["rules"]
        )
    elif any(
        w in msg
        for w in [
        ...
        response += "\n".join(
            f"**Step {s['step']}: {s['name']}** ({s['timing']})\n  Framework: {s['framework']}\n  Goal: {s['goal']}"
            for s in steps
        )
        response += "\n\n**Timing Rules:**\n" + "\n".join(
            f"⏰ {r}" for r in KNOWLEDGE_BASE["email_sequence_playbook"]["timing_rules"]
        )
        ...
        w in msg for w in ["knowledge base", "repos", "skills", "what do you know"]
    ):
        ...
        response += "**Top Sources:**\n" + "\n".join(
            f"{'✅' if s.get('status') == 'integrated' else '📌'} **{k.replace('_', ' ').title()}** — {s['repo']}"
            for k, s in list(sources.items())[:8]
        )
        response += "\n\n💡 Visit **Knowledge Base** page for full details."
    elif any(
        w in msg for w in ["video", "video marketing", "explainer", "tiktok", "reel"]
    ):
        ...
        response += "\n".join(
            f"📹 **{v['type']}**: {v['title']}\n  Pipeline: {v['pipeline']} • Cost: {v['cost']}"
            for v in videos
        )
        response += "\n\n**Capabilities:**\n" + "\n".join(
            f"🎥 {c}"
            for c in KNOWLEDGE_BASE["video_marketing_knowledge"]["capabilities"][:4]
        )
        response += "\n\n**Platforms:** " + ", ".join(
            KNOWLEDGE_BASE["video_marketing_knowledge"]["platforms"]
        )
        ...
        response = (
            "📅 **Content Calendar** (from content-strategy + social-content):\n\n"
        )
        response += "\n".join(
            f"📌 **{c['day']}**: {c['type']} — {c['topic']} ({c['platform']})"
            for c in calendar
        )
        response += "\n\n**Content Frameworks:**\n" + "\n".join(
            f"✍️ {f}"
            for f in KNOWLEDGE_BASE["content_creation_knowledge"]["content_frameworks"]
        )
        ...
        response = (
            "🔒 **Security & Compliance** (from trail-of-bits + system-design-101):\n\n"
        )
        response += "\n".join(f"🛡️ {r}" for r in rules)
        response += "\n\n**Applied From:** Trail of Bits security audits, OWASP guidelines, system-design-101 patterns"
    elif any(
        w in msg for w in ["scrape", "scraping", "crawl", "browser", "extract data"]
    ):
        ...
        response = (
            "🎯 **Lead Generation System** (from n8n + listmonk + firecrawl):\n\n"
        )
        ...
        response += (
            "**Listmonk** — Self-hosted email: templates, drip campaigns, analytics"
        )
    elif any(
        w in msg for w in ["landing page", "page builder", "email template", "design"]
    ):
                ...
                for pp in KNOWLEDGE_BASE["psychology_knowledge"][
                    ...
                    if word in pp["name"].lower() or word in pp["rule"].lower():
                        search_results.append(
                            {
                                "category": "psychology",
                                "content": f"{pp['name']}: {pp['rule']}",
                            }
                        )

        if search_results:
            response = (
                f'🔍 I found relevant knowledge for *"{data.get("message", "")}"*:\n\n'
            )
            response += "\n".join(
                f"💡 [{r['category']}] {r['content']}" for r in search_results[:4]
            )
            ...
            response += "\n".join(
                ...
                for w in wf["dmca_workflows"]
            )
            response += "\n\n**Dev Workflows (57 commands):**\n" + "\n".join(
                f"🛠️ {w}" for w in wf["dev_workflows"][:4]
            )
        elif any(
            w in msg for w in ["cost", "saving", "budget", "cheap", "free", "pricing"]
        ):
            strategies = KNOWLEDGE_BASE["cost_optimization_knowledge"]["strategies"]
            response = (
                "💰 **Cost Optimization** (from caveman + free-for-dev + commands):\n\n"
            )
            response += "\n".join(
                f"📉 **{s['area']}**: {s['method']}\n  Savings: {s['savings']}"
                for s in strategies
...
BRAIN_SKILLS = {
    ...
    "EnrichHead": {
        "email_verification": 91,
        "linkedin_scraping": 78,
        "data_enrichment": 86,
        "lead_scoring": 89,
    },
    "EmailVerifier": {
        ...
        "dns_lookup": 92,
        "bounce_detection": 88,
        "disposable_detection": 85,
    },
    "MarketingHead": {
        "copywriting": 93,
        "funnel_design": 91,
        "ab_testing": 85,
        "audience_segmentation": 88,
        "pas_framework": 95,
    },
    "Copywriter": {
        "email_copy": 96,
    ...
    "SalesHead": {
        "intent_classification": 90,
        "lead_scoring": 92,
        "follow_up_strategy": 88,
    ...
    "ReplyClassifier": {
        ...
        "intent_detection": 93,
        "keyword_extraction": 89,
        "temperature_scoring": 87,
    },
    "AccountsHead": {
        "account_setup": 90,
        "warmup_management": 88,
        "health_monitoring": 86,
        "rotation_strategy": 84,
    },
    "WarmupAgent": {
        "gradual_sending": 92,
        "reputation_building": 89,
        "deliverability_testing": 87,
        "spf_dkim_setup": 85,
    },
    "TaskHead": {
        "queue_management": 91,
        "priority_scheduling": 89,
        "progress_tracking": 87,
        "error_recovery": 83,
    },
    "QueueWorker": {
        "async_processing": 93,
    ...
    "LearningEngine": {
        "data_mining": 94,
        "rule_discovery": 91,
        "performance_modeling": 89,
        "continuous_learning": 87,
    },
    "JARVISHead": {
        "nlp_processing": 91,
        "intent_parsing": 89,
        "context_management": 87,
        "response_generation": 85,
    },
    "NLPProcessor": {
        "text_analysis": 93,
...
PERSONALITIES = {
    "ScrapeHead": {
        "tone": "methodical",
        "traits": ["precise", "thorough", "data-driven"],
        "catchphrase": "Data is king. Let me find what you need.",
    },
    "MarketingHead": {
        "tone": "creative",
        "traits": ["persuasive", "innovative", "results-focused"],
        "catchphrase": "Every word counts. Let's convert.",
    },
    "SendHead": {
        "tone": "reliable",
        "traits": ["cautious", "systematic", "safety-first"],
        "catchphrase": "Deliverability is non-negotiable.",
    },
    "SalesHead": {
        "tone": "energetic",
        "traits": ["ambitious", "relationship-builder", "closer"],
        "catchphrase": "Let me turn that lead into a client.",
    },
    "AnalyticsHead": {
        "tone": "analytical",
        "traits": ["detail-oriented", "pattern-finder", "honest"],
        "catchphrase": "The numbers don't lie. Here's what they say.",
    },
    "MLHead": {
        "tone": "curious",
        "traits": ["experimental", "data-hungry", "adaptive"],
        "catchphrase": "Every failure is a data point. Let me optimize.",
    },
    "JARVISHead": {
        "tone": "professional",
        "traits": ["helpful", "knowledgeable", "efficient"],
        "catchphrase": "At your service, boss.",
    },
    "MemoryHead": {
        "tone": "wise",
        "traits": ["patient", "archival", "reflective"],
        "catchphrase": "I remember everything. What do you need to recall?",
    },
}
...
AUTO_LEARNING = {
    ...
    "discoveries": [
        {
            ...
            "discovery": "2-4 word lowercase subjects get 60% more opens",
            "source": "Lavender research + internal A/B",
            "confidence": 95,
            "applied": True,
        },
        {
            ...
            "discovery": "Tue-Thu 9-11am local time gives 23% higher open rate",
            "source": "Internal analytics (8934 emails)",
            "confidence": 89,
            "applied": True,
        },
        {
            ...
            "discovery": "Using city + niche in subject increases opens by 18%",
            "source": "A/B test cycle 5",
            "confidence": 87,
            "applied": True,
        },
        {
            "id": 4,
            "category": "follow_up",
            "discovery": "3-day gap between emails optimal for cold outreach",
            "source": "Reply rate analysis",
            "confidence": 82,
            "applied": True,
        },
        {
            ...
            "discovery": "PAS framework outperforms AIDA by 31% for DMCA services",
            "source": "Funnel comparison test",
            "confidence": 91,
            "applied": True,
        },
        {
            ...
            "discovery": "Dentists have highest conversion (14%), followed by lawyers (12%)",
            "source": "Lead temperature analysis",
            "confidence": 88,
            "applied": True,
        },
        {
            ...
            "discovery": "Max 25 emails/hour/account prevents spam flags",
            "source": "Bounce rate monitoring",
            "confidence": 96,
            "applied": True,
        },
    ],
    "internet_sources": [
        {
            "source": "Lavender.ai research",
            "topic": "Subject line optimization",
            "last_checked": "2 hours ago",
        },
        {
            "source": "Gong.io data",
            "topic": "Cold email best practices",
            "last_checked": "4 hours ago",
        },
        {
            "source": "HubSpot blog",
            "topic": "Email marketing benchmarks 2026",
            "last_checked": "6 hours ago",
        },
        {
            "source": "Mailchimp reports",
            "topic": "Industry open rate averages",
            "last_checked": "8 hours ago",
        },
        {
            "source": "Reply.io research",
            "topic": "Follow-up sequence optimization",
            "last_checked": "12 hours ago",
        },
        {
            "source": "Woodpecker blog",
            "topic": "Cold email deliverability",
            "last_checked": "1 day ago",
        },
        {
            "source": "Reddit r/coldemail",
            "topic": "Community best practices",
            "last_checked": "1 day ago",
        },
        {
            "source": "LinkedIn Sales Navigator",
            "topic": "B2B outreach patterns",
    ...
    "skill_improvements": [
        {
            ...
            "from": 88,
            "to": 94,
            "reason": "Applied Lavender 2-4 word rule",
        },
        {
            "agent": "MarketingHead",
            "skill": "pas_framework",
            "from": 89,
            "to": 95,
            "reason": "Refined PAS templates after A/B test",
        },
        {
            "agent": "SendHead",
            ...
            "from": 85,
            "to": 91,
            "reason": "Optimized send rate to 25/hr",
        },
        {
            "agent": "MLHead",
            ...
            "from": 86,
            "to": 92,
            "reason": "Added niche-based performance tracking",
        },
        {
            "agent": "SalesHead",
            ...
            "from": 83,
            "to": 90,
            "reason": "Trained on 67 reply examples",
        },
        {
            "agent": "AnalyticsHead",
            "skill": "open_tracking",
            "from": 85,
            "to": 91,
            "reason": "Pixel tracking accuracy improvement",
        },
    ],
    "active_experiments": [
        {
            "id": "exp1",
            "name": "Fear vs Value subjects",
            "department": "marketing",
            "status": "running",
            "started": "2 days ago",
            "results_so_far": "Fear subjects 12% ahead",
        },
        {
            "id": "exp2",
            "name": "5-step vs 8-step funnel",
            "department": "marketing",
            "status": "running",
            "started": "5 days ago",
            "results_so_far": "8-step funnel 8% higher conversion",
        },
        {
            "id": "exp3",
            "name": "Morning vs afternoon sends",
            "department": "sending",
            "status": "completed",
            "started": "7 days ago",
            "results_so_far": "Morning wins by 23%",
        },
    ],
}
...
def get_discoveries():
    ...
    return jsonify(
        {
            "discoveries": AUTO_LEARNING["discoveries"],
            "total": len(AUTO_LEARNING["discoveries"]),
...
def get_skill_improvements():
    ...
    return jsonify(
        {
            "improvements": AUTO_LEARNING["skill_improvements"],
...
def run_learning_cycle():
    ...
    return jsonify(
        {
            "cycle": AUTO_LEARNING["cycle"],
            "improved_agents": len(improved),
...
KNOWLEDGE_BASE = {
    ...
    "sources": {
        ...
        "ui_components": {
            "repo": "shadcn-ui + hyperframes",
            "components": 50,
            "status": "integrated",
        },
        "prompt_engineering": {
            "repo": "Prompt-Engineering-Guide + system-prompts-leaks",
            "techniques": 25,
            "status": "integrated",
        },
        "workflow_engines": {
        ...
        "cli_tools": {
            "repo": "mistral-vibe + opencode + aider + continue",
            "features": [
                "code-generation",
                "terminal-ai",
                "pair-programming",
        ...
        "deep_sleep": {
            "repo": "DeepSleep-beta",
            "features": ["agent-hibernation", "state-preservation", "resume-context"],
            "status": "referenced",
        },
        "octogent": {
            "repo": "octogent",
            "features": ["multi-agent-teams", "task-delegation", "parallel-execution"],
            "status": "integrated",
        },
        "rowboat": {
            "repo": "rowboat",
            "features": ["agent-orchestration", "tool-management", "workflow-builder"],
            "status": "integrated",
        },
        "paperclip": {
            "repo": "paperclip",
        ...
        "openwolf": {
            "repo": "openwolf",
            "features": ["autonomous-browsing", "web-agent", "task-automation"],
            "status": "integrated",
        },
        "rtk_toolkit": {
            "repo": "rtk",
            "features": ["rust-dev-toolkit", "code-analysis", "performance-tools"],
            "status": "referenced",
        },
        "commands_57": {
            "repo": "commands",
        ...
        "caveman_optimization": {
            "repo": "caveman",
            "features": [
                "75-percent-token-savings",
                "output-compression",
                "terse-commits",
                "one-line-reviews",
                "input-compression-46-percent",
    ...
    "cold_email_knowledge": {
        ...
        "frameworks": [
            {
                "name": "Observation → Problem → Proof → Ask",
                "desc": "You noticed X, which usually means Y. We helped Z. Interested?",
            },
            {
                "name": "Question → Value → Ask",
                "desc": "Struggling with X? We do Y. Company Z saw [result]. Worth a look?",
            },
            {
                "name": "Trigger → Insight → Ask",
                "desc": "Congrats on X. That creates Y challenge. We've helped with that.",
            },
            {
                "name": "Story → Bridge → Ask",
                "desc": "[Similar company] had [problem]. They [solved it]. Relevant?",
            },
            {
                "name": "PAS (Problem-Agitate-Solve)",
                "desc": "Identify pain, amplify urgency, present solution",
            },
            {
                "name": "AIDA (Attention-Interest-Desire-Action)",
                "desc": "Capture attention, build interest, create desire, drive action",
            },
        ],
        "subject_line_rules": [
    ...
    "psychology_knowledge": {
        ...
        "persuasion_principles": [
            {
                "name": "Loss Aversion",
                "rule": "Losses feel 2x as painful as gains. Frame as 'what you'll lose by not acting'",
            },
            {
                "name": "Social Proof",
                "rule": "Show customer counts, testimonials, logos. Numbers create confidence",
            },
            {
                "name": "Scarcity",
                "rule": "Limited availability increases value. Only use when genuine",
            },
            {
                "name": "Reciprocity",
                "rule": "Give first (free content/tools), people feel obligated to return",
            },
            {
                "name": "Authority",
                "rule": "Feature expert endorsements, certifications, 'featured in' logos",
            },
            {
                "name": "Anchoring",
                "rule": "Show higher price first to anchor expectations",
            },
            {
                "name": "Commitment",
                "rule": "Small commitments lead to bigger ones (email signup → trial → paid)",
            },
            {
                "name": "Endowment Effect",
                "rule": "Free trials let customers 'own' the product — reluctant to give up",
            },
            {
                "name": "Peak-End Rule",
                "rule": "People judge by peak moment + ending. Design memorable peaks",
            },
            {
                "name": "Zeigarnik Effect",
                "rule": "Unfinished tasks occupy mind. 'You're 80% done' creates pull",
            },
        ],
        "pricing_psychology": [
    ...
    "lead_magnet_knowledge": {
        ...
        "dmca_lead_magnets": [
            {
                "type": "Checklist",
                "name": "DMCA Review Removal Checklist",
                "effort": "Low",
                "conversion": "25-35%",
            },
            {
                "type": "Guide",
                "name": "5-Step Guide to Protecting Your Online Reputation",
                "effort": "Medium",
                "conversion": "20-30%",
            },
            {
                "type": "Template",
                "name": "DMCA Takedown Letter Template (Ready to Send)",
                "effort": "Low",
                "conversion": "30-40%",
            },
            {
                "type": "Calculator",
                "name": "Revenue Lost to Bad Reviews Calculator",
                "effort": "Medium",
                "conversion": "35-45%",
            },
            {
                "type": "Case Study",
                "name": "How [Business] Removed 47 Fake Reviews in 30 Days",
                "effort": "Medium",
                "conversion": "15-25%",
            },
        ],
    ...
    "ab_testing_knowledge": {
        ...
        "current_experiments": [
            {
                "name": "Subject: Fear vs Value",
                "hypothesis": "Loss-aversion subjects get higher open rates",
                "status": "running",
                "metric": "open_rate",
            },
            {
                "name": "Funnel: 5-step vs 8-step",
                "hypothesis": "Longer funnel builds more trust = higher close rate",
                "status": "running",
                "metric": "reply_rate",
            },
            {
                "name": "Send Time: 9AM vs 2PM",
                "hypothesis": "Morning sends get opened, afternoon gets replied to",
                "status": "completed",
                "metric": "reply_rate",
            },
        ],
        ...
        "dmca_sequence": [
            {
                ...
                "name": "The Opener",
                "timing": "Day 0",
                "framework": "Observation → Problem",
                "goal": "Get their attention with a specific review issue",
            },
            {
                "step": 2,
                "name": "Value Drop",
                ...
                "goal": "Share a result — '47 reviews removed in 30 days'",
            },
            {
                "step": 3,
                "name": "Social Proof",
                ...
                "goal": "Show competitors using the service",
            },
            {
                "step": 4,
                ...
                "timing": "Day 7",
                "framework": "FAQ + Value",
                "goal": "Address 'Is this legal?' and 'How long does it take?'",
            },
            {
                "step": 5,
                "name": "The Breakup",
                "timing": "Day 10",
                "framework": "Scarcity + Loss Aversion",
                "goal": "Last chance — honor the breakup email",
            },
        ],
        "timing_rules": [
    ...
    "video_marketing_knowledge": {
        ...
        "dmca_video_ideas": [
            {
                "type": "Explainer",
                "title": "How Fake Reviews Destroy Your Business (60s)",
                "pipeline": "animated-explainer",
                "cost": "$0.15-$1.50",
            },
            {
                "type": "Testimonial",
                "title": "47 Reviews Removed in 30 Days (90s)",
                "pipeline": "documentary-montage",
                "cost": "$0.00 (free stock)",
            },
            {
                "type": "Product Demo",
                "title": "DMCAShield Dashboard Walkthrough (120s)",
                "pipeline": "screen-demo",
                "cost": "$0.00 (local)",
            },
            {
                "type": "Social Ad",
                "title": "Stop Losing Customers to Fake Reviews (30s)",
                "pipeline": "animation",
                "cost": "$0.50-$1.00",
            },
            {
                "type": "Educational",
                "title": "DMCA Law Explained in 60 Seconds",
                "pipeline": "animated-explainer",
                "cost": "$0.15",
            },
        ],
        ...
        "content_calendar": [
            {
                "day": "Monday",
                "type": "Educational",
                "topic": "DMCA law tips, review management",
            ...
            },
            {
                "day": "Wednesday",
                "type": "Video",
                "topic": "Quick tips, explainers",
                "platform": "TikTok + Reels",
            },
            {
                "day": "Thursday",
                "type": "Social Proof",
                "topic": "Testimonials, stats",
                "platform": "Twitter + LinkedIn",
            },
            {
                "day": "Friday",
                "type": "Behind the Scenes",
                "topic": "Team, process, culture",
        ...
        "dmca_workflows": [
            {
                ...
                "steps": [
                    "Scrape → Verify → Score → Enrich → Outreach → Follow-up → Close"
                ],
                "tools": "huginn webhooks + dify RAG + flowise chatflows",
            },
            {
                "name": "Review Monitoring",
                "steps": ["Monitor → Detect → Classify → Alert → Action → Report"],
                "tools": "huginn + posthog analytics",
            },
            {
                "name": "DMCA Filing Automation",
                "steps": ["Evidence → Draft → Review → Submit → Track → Confirm"],
                "tools": "paperclip doc processing + dify workflows",
            },
            {
                "name": "Client Reporting",
                "steps": ["Collect → Analyze → Visualize → Generate → Deliver"],
    ...
    "cost_optimization_knowledge": {
        ...
        "strategies": [
            {
                "area": "API Costs",
                "method": "Caveman output compression",
                "savings": "75% fewer tokens = 75% less cost",
                "source": "caveman repo — proven benchmarks: 22-87% savings across tasks",
            },
            {
                "area": "Hosting",
                "method": "Free tier stacking",
                "savings": "$0/month for MVP",
                "source": "free-for-dev: Vercel (free), Netlify (free), Cloudflare (free)",
            },
            {
                "area": "Email",
                "method": "Free tier email services",
                "savings": "$0 for first 10k emails/month",
                "source": "public-apis: SendGrid free, Mailgun free tier",
            },
            {
                "area": "Analytics",
                "method": "Self-hosted PostHog",
                "savings": "Free unlimited events",
                "source": "posthog + coolify self-hosting",
            },
            {
                "area": "Video Content",
                "method": "OpenMontage free pipeline",
                "savings": "$0.00-$0.15 per video",
                "source": "open-montage: Piper TTS (free) + stock footage (free)",
            },
            {
                "area": "AI/ML",
                "method": "OpenRouter cheapest models",
                "savings": "10x cheaper than direct API",
...
def search_knowledge():
    ...
    for p in KNOWLEDGE_BASE["cold_email_knowledge"]["principles"]:
        if q in p.lower():
            results.append(
                {"category": "cold_email", "type": "principle", "content": p}
            )
            ...
            results.append(
                {
                    ...
                    "type": lm["type"],
                    "content": f"{lm['name']} ({lm['conversion']})",
                }
            )
            ...
            results.append(
                {
                    "category": "ab_testing",
                    "type": "experiment",
                    "content": f"{exp['name']}: {exp['hypothesis']}",
                }
            )
    ...
    for step in KNOWLEDGE_BASE["email_sequence_playbook"]["dmca_sequence"]:
        if q in step["name"].lower() or q in step["goal"].lower():
            results.append(
                {
                    "category": "email_playbook",
                    "type": f"step_{step['step']}",
                    "content": f"Step {step['step']}: {step['name']} — {step['goal']}",
                }
            )
    ...
    for skill in KNOWLEDGE_BASE["sources"]["marketing_skills"]["categories"]:
        if q in skill.lower():
            results.append(
                {"category": "marketing_skill", "type": "skill", "content": skill}
            )
            ...
            results.append(
                {
                    "category": "repo",
                    "type": "source",
                    "content": f"{key}: {src['repo']} ({src['status']})",
                }
            )
    ...
    try:
        ...
        if not creds:
            return jsonify(
                {
                    "success": False,
                    "message": "No Gmail credentials configured. Add an account via UI or set env vars.",
                }
            )
...
def scrape_businesses():
    ...
    try:
        ...
        result = run_scraper_pipeline(
            task_id, business_type, city, state, country, max_results
        )
        return jsonify(result)
    except Exception as e:
...
def full_system_status():
    ...
    try:
        from agents.real_lead_engine import (
            get_lead_stats,
            get_gmail_status,
            get_campaigns,
        )
